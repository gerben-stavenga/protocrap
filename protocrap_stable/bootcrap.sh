...
RUST_BACKTRACE=full cargo run -p protocrap-codegen --bin protocrap-codegen --features bootcrap -- /tmp/protocrap-descriptor-set.bin protocrap/src/descriptor.pc.rs
